...
<div class="row">
			...
			<table class="table">
				...
				<tbody>
					...
					<?php endif; ?>
					<?php foreach ($subscribe as $sbr): ?>
					<tr>
						<th><?php echo ++$start; ?></th>
						
						<th><?php echo $sbr ['email']; ?></th>
						<th><?php echo date('h:i:sa d F Y ', $sbr ['date_receive']); ?></th>
						
						<td>
							
							
							<a href="<?php echo base_url(); ?>admin/hapus/<?php echo $sbr['id']; ?>" class="badge badge-danger" onclick="return confirm('yaqueen?');">delete</a>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
